<div x-data = "
            ...
            "
     class="flex items-center px-2 ustify-around gap-2">
    <!-- Datum -->            
    <div class="basis-1/6" >   
        <x-input.date
    ...
    <div class="basis-1/6" >   
        <input
            wire:model.lazy="current.Co2consupmtion"
            ...
            class="{{ $cost->co2Tax ? 'block' : 'hidden' }} bg-white border text-right md:text-md focus:ring-black p-1 px-2 m-0 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"   
            >
    </div>
    <!-- CO2 Betrag -->        
    <div class="basis-1/6" >
        <input type="text"    
            ...
            inputmode="numeric"  
            wire:model.lazy= {{ $netto ? 'current.Co2brutto' : 'current.Co2brutto' }}
            style="-moz-appearance: textfield; margin: 0;"
