                        ...
                        <div class="flex-1 truncate border-sky-100 ">
                            <div class="w-full text-gray-700">
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <span class="">{{ $occupant->houseNr}}</span>
                                </div>
                                <div class="">
                                    <span class="font-bold text-md sm:text-md">Fläche / Personenzahl:</span>
                                    <span class="text-md sm:text-md">{{number_format($occupant->qmkc,  2, ',', '.') }}</span>
                                    <span class="text-md sm:text-md">{{'/ '.$occupant->pe}}</span>
                                </div>
                                <div class="">
                                    <span class="font-bold text-md sm:text-md">Zeitraum:</span>
                                    <span class="text-md sm:text-md">von{{ ' '.$occupant->date_from_editing }}</span>
                                    <span class="text-md sm:text-md">bis{{ ' '.$occupant->date_to_editing }}</span>
                                </div>
                                <div class="">
                                    <div class="">
                                        <span class="font-bold text-md sm:text-md">Verschieben</span>
                                    </div>
                                    <div class="">
                                        <span class="font-bold text-md sm:text-md">von Änderungen:</span>
                                        <span class="text-md sm:text-md">von</span>
                                        <span class="text-md sm:text-md">bis</span>
                                    </div>
                                </div>
                                <div class="">
