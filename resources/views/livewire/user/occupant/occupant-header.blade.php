<div>
    ...
    <div class="sm:hidden">
        <div class="flex">
            ...
            @endif
            @if ($addAction)
                <x-icon.fonts.users-add wire:click='raise_CreateVerbrauchsinfoUserEmailModal' class="inline-block pt-2 pr-2 align-text-bottom text-sky-900 fa-lg "></x-icon.fonts.users-add>
            @endif
