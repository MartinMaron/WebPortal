                    ...
                    <div class="block sm:invisible ">
                        <div class="flex">
                            ...
                            <div class="inline-block align-bottom basis-1/6">
                                <x-icon.fonts.email-active :value='$userEmail->aktiv'
                                                           class="px-4 py-1 text-sm border-2"></x-icon.fonts.email-active>
                            </div>
                            <div class="basis-1/6 ">
                                <x-icon.fonts.pencil
                                    class="px-4 py-1 text-sm border-2 border-sky-200"></x-icon.fonts.pencil>
                            </div>
                            <div class="basis-1/6 ">
                                <x-icon.fonts.trash
                                    class="px-4 py-1 text-sm border-2 border-sky-200"></x-icon.fonts.trash>
                            </div>
                        </div>
                    </div>
                </div>
