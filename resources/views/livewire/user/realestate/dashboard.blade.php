<div>
    <div class="grid grid-cols-1 mt-4 gap-4 sm:grid-cols-2">
        <div class="relative flex items-center px-6 py-5 space-x-3 bg-white border border-gray-300 rounded-lg shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
            ...
            <div class="flex-1 min-w-0">
                <a href="{{route('user.realestateOccupantList', $realestate)}}" class="focus:outline-none">
                    ...
                    <p class="{{ $realestate->abrechnungssetting->nutzerlisteDone ? 'block text-green-800 font-semibold' : 'hidden'}}">ist bereitgestellt</p>
                </a>
            </div>
        ...
        <div class="relative flex items-center px-6 py-5 space-x-3 bg-white border border-gray-300 rounded-lg shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
            ...
            <div class="flex-1 min-w-0">
                <a href="{{route('user.costs', $realestate)}}" class="focus:outline-none">
                    <span class="absolute inset-0" aria-hidden="true"></span>
                    <p class="font-medium text-gray-900 text-md">Brennstoffkosten</p>
        ...
        <div class="relative flex items-center px-6 py-5 space-x-3 bg-white border border-gray-300 rounded-lg shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
            <div class="flex-shrink-0">
                <i class="fa-duotone fa-solid fa-file-signature text-2xl sm:text-4xl text-sky-700 hover:text-sky-300"></i>                
            </div>
            <div class="flex-1 min-w-0">
                <a href="{{route('user.heizkostenliste', $realestate)}}" class="focus:outline-none">
                    <span class="absolute inset-0" aria-hidden="true"></span>
                    <p class="font-medium text-gray-900 text-md">weitere Heizkosten</p>
                    <p class="text-gray-700 text-md line-clamp-4 md:line-clamp-2">Hier können Sie die Kosten eintragen und diese Bearbeiten</p>
        ...
        <div class="relative flex items-center px-6 py-5 space-x-3 bg-white border border-gray-300 rounded-lg shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
            ...
            <div class="flex-1 min-w-0">
                <a href="{{route('user.betriebskostenliste', $realestate)}}" class="focus:outline-none">
                    <span class="absolute inset-0" aria-hidden="true"></span>
                    <p class="font-medium text-gray-900 text-md">Betriebskosten</p>
                    <p class="text-gray-500 text-md line-clamp-4 md:line-clamp-2">Hier können Sie die Kosten eintragen und diese Bearbeiten</p>
