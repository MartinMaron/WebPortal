                    ...
                    <div>
                        ...
                        <div class="flex h-8 m-2 justify-start items-center">
                            ...
                            @if ($realestate->nutzerlisteactive)
                                <a href="{{route('user.realestateOccupantList', $realestate)}}" class="w-0 py-4 mx-6 text-sm font-medium text-gray-700 border border-transparent rounded-br-lg hover:text-gray-500">
                            ...
                            @if ($realestate->kosteneingabe)
                                <a href="{{route('user.costs', $realestate)}}" class="w-0 py-4 mx-6 text-sm font-medium text-gray-700 border border-transparent rounded-br-lg hover:text-gray-500">
                                ...
                                <a href="{{route('user.heizkostenliste', $realestate)}}" class="w-0 py-4 mx-6 text-sm font-medium text-gray-700 border border-transparent rounded-br-lg hover:text-gray-500">
                                ...
                                @if ($realestate->betriebskosten)
                                    <a href="{{route('user.betriebskostenliste', $realestate)}}" class="w-0 py-4 mx-6 text-sm font-medium text-gray-700 border border-transparent rounded-br-lg hover:text-gray-500">
