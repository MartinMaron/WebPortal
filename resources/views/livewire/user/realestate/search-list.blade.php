                        ...
                        <div class="flex-1 truncate  border-sky-100 ">
                            ...
                            <div>
                                @if ($realestate->heizkosten)
                                    <span class="flex-shrink-0 inline-block px-1 py-0.5 text-green-800 text-xs font-medium bg-green-100 rounded-full">Heizkosten</span>
                                @endif
                                @if ($realestate->miete)
                                    <span class="flex-shrink-0 inline-block px-1 py-0.5 text-green-800 text-xs font-medium bg-green-100 rounded-full">Wärmedienst Gerätemiete</span>
                                @endif
                                @if ($realestate->rauchmelder)

                                    <span class="flex-shrink-0 inline-block px-1 py-0.5 text-green-800 text-xs font-medium bg-green-100 rounded-full">Rauchmelder</span>
                                @endif
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="flex h-8">
                            <div class="flex flex-1 w-0">
                                <a href="{{route('user.realestate', $realestate)}}" class="relative inline-flex items-start justify-start flex-1 w-0 px-1 py-2 text-sm font-medium text-gray-700 border border-transparent rounded-br-lg hover:text-gray-500">
