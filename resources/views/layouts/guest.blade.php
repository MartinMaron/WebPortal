        ...
        <div class="bg-white">
            ...
            <div class="bg-sky-200 opacity-75 block sm:flex sm:justify-center sm:items-center">
                ...
                <div class="border-l-2 border-sky-800">
                    <div class="pl-10 opacity-100"><div class=""><span class="text-sky-600">eneko GmbH</span><br>Ansprechpartner: Christof Jaskula<br>Marsdorfer Str. 76<br>50858 Köln<br>Tel.: +49 (0)221 4300073<br>info@e-neko.de</div></div>
                </div>
            </div>
