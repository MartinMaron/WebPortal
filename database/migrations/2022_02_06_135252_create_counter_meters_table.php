...
class CreateCounterMetersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('verbrauchinfos_counter_meters', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('counter_meters');
    }
}
